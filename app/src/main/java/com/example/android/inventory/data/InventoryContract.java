...
public final class InventoryContract {
    ...
    public static abstract class inventoryTable implements BaseColumns{
        ...
        public static final String COLOUMN_PRODUCT_SUPPLIER = "supplier";
        ...
        public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME +
                ...
                " TEXT NOT NULL," + COLOUMN_PRODUCT_SUPPLIER + " TEXT NOT NULL," + COLOUMN_QUANTITY + " INT NOT NULL," + COLOUMN_PRICE +
